...
export const prisonMap: PrisonMap = {
  ...
  hidingSpots: [
    { id: "locker_alpha", type: "locker", position: { x: 11.1, y: 4.5 } },
  ...
  coverObjects: [
    ...
    { id: "central_service_wall_left", position: { x: 13.475, y: 6.2 }, width: 0.95, height: 0.24 },
    ...
    { id: "storage_room_west_wall", position: { x: 13.09, y: 7.5 }, width: 0.18, height: 3.0 },
  ...
  setDressingObjects: [
    ...
    { id: "starter_cell_cot", kind: "cot", position: { x: 2.05, y: 2.05 }, width: 1.52, height: 0.68 },
    { id: "starter_cell_toilet", kind: "toilet", position: { x: 3.45, y: 3.0 }, width: 0.5, height: 0.5 },
    { id: "prisoner_cell_a_cot", kind: "cot", position: { x: 5.25, y: 2.05 }, width: 1.36, height: 0.68 },
    { id: "prisoner_cell_a_toilet", kind: "toilet", position: { x: 6.2, y: 3.0 }, width: 0.5, height: 0.5 },
    { id: "prisoner_cell_a_prisoner", kind: "prisoner", position: { x: 5.55, y: 2.75 }, width: 0.34, height: 0.46 },
    { id: "prisoner_cell_b_cot", kind: "cot", position: { x: 7.55, y: 2.05 }, width: 1.36, height: 0.68 },
    { id: "prisoner_cell_b_toilet", kind: "toilet", position: { x: 8.45, y: 3.0 }, width: 0.5, height: 0.5 },
    ...
    { id: "security_status_lights", kind: "status_lights", position: { x: 21.2, y: 1.75 }, width: 0.55, height: 0.12 },
  ],
  patrolRoutes: [
    {
      id: "west_loop",
